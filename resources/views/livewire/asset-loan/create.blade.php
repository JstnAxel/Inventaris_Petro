<div class="space-y-6">
    <form wire:submit.prevent="submit" class="space-y-4 mb-10">
        ...
        <button type="button" wire:click="addRow" class="bg-blue-500 text-white px-4 py-1 rounded">+ Tambah Asset</button>
...
<table class="w-full border text-sm">
    <thead class="bg-gray-200 dark:bg-gray-700">
        <tr>
            ...
            <th class="border px-4 py-2 text-start">Kode Peminjaman</th> <!-- Tambah header -->
        </tr>
    </thead>
    <tbody>
